---
layout: post
title: "Taking baby steps when moving to an ERP system"
date: 2021-04-20 00:00:00 +0000
description: "Implementing an ERP system doesn't have to be an ordeal.  Find out how you can deploy Fraction ERP in bite sized chunks."
category: management
...
Using [**quotes and sales orders**](https://vimeo.com/519886128) along with [**invoicing**](https://vimeo.com/532613354), allows the customer facing elements of Fraction to be rolled out first. At this point, you can keep on working the way you are for everything else.


[**Delivery notes**](https://vimeo.com/532607112) can be produced for your orders, which starts to create stock transactions.
...
You can create simple manufacturing orders with Fraction ERP, without [**creating detailed BOMs**](https://vimeo.com/519885601). A 'manufactured' part is required for a new BOM, created with just a few clicks.

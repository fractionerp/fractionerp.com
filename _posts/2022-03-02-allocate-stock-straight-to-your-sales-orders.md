...
With [**Fraction ERP**](https://fractionerp.com/) you can allocate stock directly to the sales order, negating the need to have a work order for each sales order.

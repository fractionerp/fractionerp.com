---
layout: post
title: "My top five features in Fraction ERP"
date: 2024-03-06 20:57:04 +0000
description: "Learn which features of Fraction ERP are Giles' top five. Clue - he used to be a production manager!"
category: general
...
To run a meeting like this effectively, you need good data. It would therefore seem obvious that our [**dashboard **](https://fractionerp.com/dashboard)would be one of my favourite features. It contains key data, including exception data that needs to be addressed on a daily basis. With one click, you can drill down into the data.

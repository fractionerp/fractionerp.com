---
layout: post
title: "Fraction ERP is fully mobile!"
date: 2020-11-25 14:18:54 +0000
description: "Discover the small change we have made to make Fraction ERP fully mobile."
category: general
...
The original design of Fraction ERP was to be a simple, fast and effective tool that you can use from any web browser on your desktop / laptop machine. Now that we have updated the menu system, you can now use Fraction ERP comfortably from your tablet or smartphone.
...
Running an ERP system from a mobile device can be a challenge. Thankfully, this is one challenge that Fraction ERP has overcome.


If you want to [learn more about Fraction ERP](https://fractionerp.com/features/), and more importantly, how it can help your business to become more efficient and more effective, then sign up for a free demo using the form below.
---
layout: post
title: "Using the 5 Why method with Fraction ERP"
date: 2021-03-23 17:45:17 +0000
description: "Learn how the '5 Why' root cause problem works and how it is integrated with the NCR module of Fraction ERP."
category: general
...
1. You have an 'aha!' moment (when you realise that the cause is now frighteningly obvious!).
2. The solution to the root cause is in your control and is simple in nature.
...
If you want to learn more about Fraction ERP then sign up for a free demo using the form below, or [**view our video walkthroughs here**](https://vimeo.com/showcase/8283119).